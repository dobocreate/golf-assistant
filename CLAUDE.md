...
**現在のフェーズ:** Post-MVP Sprint 2 完了。全機能実装済み・デプロイ済み。
...
| rounds | ラウンド（ステータス: in_progress / completed） | 00001 |
| scores | ホール別スコア（打数, パット, FW, GIR, ティーショット方向, OB/バンカー/ペナルティ数） | 00001, 00005 |
| shots | ショット記録（クラブ, 結果, ミス, 方向, ライ, 傾斜） | 00001, 00006 |
