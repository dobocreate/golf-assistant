...
**現在のフェーズ:** Sprint 2 開始前（Sprint 0-1 完了、STORY-001〜006 マージ済み）
...
| Sprint 2 | スコア記録 + 音声機能 | STORY-007〜009, 011 |
| Sprint 3 | AIキャディー（コア機能） | STORY-012〜014, 010 |
| Sprint 4 | 振り返り + 仕上げ → MVP完成 | STORY-015〜018 |
