...
export function CompanionScoreModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md max-h-[85vh] rounded-t-2xl bg-gray-800 border-t border-gray-600 p-5 pb-[calc(var(--play-nav-height,80px)/2+env(safe-area-inset-bottom,0px))] space-y-4 animate-in slide-in-from-bottom duration-200 overflow-y-auto">
        {/* ヘッダー */}
