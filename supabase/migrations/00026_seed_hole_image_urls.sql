...
UPDATE holes
SET image_url = '/courses/ube72-mannenike-west/images/hole' || LPAD(hole_number::text, 2, '0') || '.png'
WHERE course_id = '3e405465-3785-4fb7-907c-22bfbf7b27de'
  AND image_url IS NULL;

UPDATE holes
SET image_url = '/courses/ube72-ajisu/images/hole' || LPAD(hole_number::text, 2, '0') || '.png'
